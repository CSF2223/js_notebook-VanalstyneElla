...
newEngland.push("New York");       //Adds new elements to the end of an array
newEngland.pop();                       // Removes the last element of an array
newEngland.indexOf("Rhode Island", 0);   // search the array for an element
